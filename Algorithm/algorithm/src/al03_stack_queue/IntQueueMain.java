...
public class IntQueueMain {
	...
	static String getMenu() {
		// 3. 제일 앞의 값을 구하여 출력
		// 4. 큐의 크기, 데이터의 수, front 인덱스, rear 인덱스, 처음값, 마지막 값을 구하라  
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(menu.equals("9")) { // 9. end 선택시
				...
				case "2" : // 큐의 데이터 가져오기 (제일 앞에, ex 은행 번호표)
					try {
				...
				case "4" : // 4. 큐의 크기, 데이터의 수, front 인덱스, rear 인덱스, 처음값, 마지막 값을 구하라
